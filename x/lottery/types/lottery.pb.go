...
func (m *Lottery) GetIndex() uint64 {
	if m != nil {
		return m.Index
	}
	return 0
...
func (m *Lottery) GetWinner() string {
	if m != nil {
		return m.Winner
	}
	return ""
...
var fileDescriptor_2afbd19f2e624dbf = []byte{
	...
	0x28, 0xad, 0x14, 0xc8, 0xc5, 0xee, 0x03, 0x61, 0x0a, 0x89, 0x70, 0xb1, 0x66, 0xe6, 0xa5, 0xa4,
	0x56, 0x48, 0x30, 0x2a, 0x30, 0x6a, 0xb0, 0x04, 0x41, 0x38, 0x42, 0x62, 0x5c, 0x6c, 0xe5, 0x99,
	0x79, 0x79, 0xa9, 0x45, 0x12, 0x4c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0x50, 0x9e, 0x90, 0x04, 0x17,
	0x7b, 0x72, 0x51, 0x6a, 0x62, 0x49, 0x7e, 0x91, 0x04, 0x33, 0x58, 0x02, 0xc6, 0x75, 0x32, 0x3c,
	0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39, 0xc6, 0x07, 0x8f, 0xe4, 0x18, 0x27, 0x3c, 0x96, 0x63,
	0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63, 0x39, 0x86, 0x28, 0x71, 0x98, 0xa3, 0x2a, 0xe0, 0xce,
	0x2b, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0xbb, 0xce, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff,
	0x61, 0x41, 0xfc, 0x9f, 0xbe, 0x00, 0x00, 0x00,
}
...
func (m *Lottery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Winner) > 0 {
		...
		i = encodeVarintLottery(dAtA, i, uint64(len(m.Winner)))
		i--
		dAtA[i] = 0x12
	}
	if m.Index != 0 {
		i = encodeVarintLottery(dAtA, i, uint64(m.Index))
		i--
		dAtA[i] = 0x8
	}
